...
const RegisterUser = () => {
    ...
    const onsubmit = async (data) => {
        ...
        // saveUser(data); // Dispatch user data action
        console.log(data);
      };
  ...
  return (
    <div className="flex justify-center items-center min-h-screen py-8" style={{background: `url(${background})`}}>
        <div className="overflow-x-auto w-full max-w-3xl">
            ...
            >
            <h2 className="text-2xl font-semibold text-center text-blue-600">Create Your Account</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <input
                        ...
                        pattern: {
                            value: /^[0-9]{10}$/, // Match exactly 10 digits
            ...
            {/* Links */}
                <div className="mt-4 text-center">
                    <p className="text-m font-semibold text-gray-500">
                        Already have an account? <a href="/" className="hover:underline text-blue-600 font-normal">User Login</a>
                    </p>
                </div>
            </form>
